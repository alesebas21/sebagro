...
import BLL.Autorizacion;
import BLL.Balanza;
import BLL.Calidad;
import BLL.CartaPorte;
import BLL.Chofer;
import BLL.Reporte;
import BLL.Usuario;
...
public class Sebagro {
    public static void main(String[] args) {
        ...
        if (opcion == JOptionPane.OK_OPTION) {
            ...
            Usuario autenticado = UsuarioDAO.autenticarUsuario(usuarioInput, contraseniaInput);
            if (autenticado != null) {
        ...
        if (elegido == 0) {
            ...
            while (continuarABM) {
                ...
                case 0: 
                    ...
                    boolean usuarioCreado = UsuarioDAO.crearUsuario(nombreDelUsuario, nuevoUsuario, nuevaContrasenia, nuevoIdRol);
                    if (usuarioCreado) {
                ...
                case 1: 
                    ...
                    boolean usuarioModificado = UsuarioDAO.actualizarUsuario(usuarioAModificar, nuevaContraseniaModificar, nuevoIdRolModificar, nuevoNombre);
                    ...
                    case 2: 
                        ...
                        boolean usuarioEliminado = UsuarioDAO.eliminarUsuario(usuarioAEliminar);
                        if (usuarioEliminado) {
